      ...
      <main className="pt-20">
          ...
          <div className="max-w-max-width mx-auto px-gutter-desktop grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <h1 className="font-headline-xl text-headline-xl text-on-surface leading-tight">
                Smarter Facility Maintenance.{" "}
                <span className="text-secondary">Connected Workflows.</span>{" "}
                Faster Resolution.
              </h1>
              <p className="font-body-lg text-body-lg text-on-surface-variant max-w-xl">
                MaintainPro connects organizations with vendors
                in real-time using intelligent job dispatch and location-based
                matching.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to={PUBLIC_ROUTES.SIGNUP_ORG}
                  className="bg-primary text-on-primary px-8 py-4 rounded-lg font-label-md shadow-lg shadow-primary/20 hover:shadow-xl transition-all"
                >
                  Get Started as an Organization
                </Link>
                <Link
                  to={PUBLIC_ROUTES.SIGNUP}
                  className="border border-outline text-primary px-8 py-4 rounded-lg font-label-md hover:bg-surface-container-low transition-all"
                >
              ...
              <div className="glass-card rounded-xl p-4 shadow-2xl overflow-hidden border-border-subtle">
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="bg-surface-subtle p-3 rounded-lg border border-border-subtle">
                    ...
                    <div className="text-headline-md font-headline-md text-status-success">
                      98%
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-max-width mx-auto px-gutter-desktop">
            <div className="text-center mb-16">
              <h2 className="font-headline-xl text-headline-xl mb-4">
                Powerful Enterprise Toolkit
              </h2>
              <p className="text-on-surface-variant max-w-2xl mx-auto font-body-lg">
                Our platform is designed to handle the complexities of
                large-scale facilities management with ease.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-2 glass-card p-8 rounded-2xl border border-border-subtle hover:border-primary/30 transition-all group">
                ...
                <p className="text-on-surface-variant">
                  Centralized hub for tracking every ticket from inception to
                  sign-off. Automated status updates keep all stakeholders
                  informed without manual entry.
                </p>
              </div>
              <div className="glass-card p-8 rounded-2xl border border-border-subtle hover:border-primary/30 transition-all group">
                ...
                <p className="text-on-surface-variant">
                  Instant notifications to the right vendors as soon as a
                  request is logged.
                </p>
              </div>
              <div className="glass-card p-8 rounded-2xl border border-border-subtle hover:border-primary/30 transition-all group">
                ...
                <p className="text-on-surface-variant">
                  Smart routing finds the closest qualified vendor to minimize
              ...
              <div className="md:col-span-2 glass-card p-8 rounded-2xl border border-border-subtle hover:border-primary/30 transition-all group">
                ...
                <p className="text-on-surface-variant">
                  Dedicated dashboards for organization admin, facility managers, in-house
                  technicians, staffs, finance, and vendor organizations with team lead and technicians, ensuring everyone sees
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-3 gap-12">
                <div className="bg-white p-8 rounded-2xl text-center space-y-4 border border-border-subtle relative">
                  ...
                  <p className="text-on-surface-variant">
                    Input asset details and priority levels via mobile or
                    desktop app.
                  </p>
                </div>
                <div className="bg-white p-8 rounded-2xl text-center space-y-4 border border-border-subtle relative">
                  ...
                  <p className="text-on-surface-variant">
                    AI matches services and proximity to find the best provider in
                    minutes.
                  </p>
                </div>
                <div className="bg-white p-8 rounded-2xl text-center space-y-4 border border-border-subtle relative">
                  ...
                  <p className="text-on-surface-variant">
                    Verify completion with photos, digital signatures, and
                    instant invoices.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-max-width mx-auto px-gutter-desktop grid md:grid-cols-2 gap-px bg-primary-container/20 overflow-hidden rounded-3xl border border-primary-container">
            <div className="p-12 lg:p-20 flex flex-col justify-center space-y-6">
              ...
              <p className="text-primary-fixed text-body-lg">
                Maintain assets with surgical precision. Reduce overhead,
                eliminate paper logs, and get 24/7 visibility into your facility
                health.
              </p>
              ...
              <Link
                to={PUBLIC_ROUTES.SIGNUP_ORG}
                className="bg-white text-primary px-8 py-4 rounded-lg font-label-md w-fit hover:bg-primary-fixed transition-colors"
              >
                Start Organizing
              </Link>
            </div>
            <div className="p-12 lg:p-20 flex flex-col justify-center space-y-6 bg-primary-container">
              ...
              <p className="text-primary-fixed text-body-lg">
                Grow your business with a steady stream of local maintenance
                jobs. Manage your team and payments in one place.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  <span
              ...
              <Link
                to={PUBLIC_ROUTES.SIGNUP}
                className="bg-secondary text-on-primary px-8 py-4 rounded-lg font-label-md w-fit hover:opacity-90 transition-colors"
              >
                Apply to Join
              </Link>
            </div>
        ...
        <section className="py-24" id="pricing">
          <div className="max-w-max-width mx-auto px-gutter-desktop">
            <div className="text-center mb-16">
              <h2 className="font-headline-xl text-headline-xl mb-4">
                Scalable Pricing for Every Scale
              </h2>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white border border-border-subtle p-8 rounded-2xl hover:border-primary transition-colors flex flex-col">
                ...
                <div className="text-headline-xl font-headline-xl mb-6">
                  $49
                ...
                <p className="text-on-surface-variant mb-8 font-body-md">
                  Ideal for small facilities with under 50 assets.
                </p>
                ...
                <Link
                  to={PUBLIC_ROUTES.SIGNUP_ORG}
                  className="block w-full rounded-lg border border-primary py-3 text-center font-label-md text-primary transition-all hover:bg-surface-container-low"
                >
                  Choose Starter
                </Link>
              </div>
              ...
              <div className="bg-white border-2 border-primary p-8 rounded-2xl shadow-xl flex flex-col relative scale-105 z-10">
                ...
                <p className="text-on-surface-variant mb-8 font-body-md">
                  Perfect for multi-site organizations and growing vendors.
                </p>
                <ul className="space-y-4 mb-12 flex-grow">
                  <li className="flex items-center gap-3 font-body-md">
                    <span
                ...
                <Link
                  to={PUBLIC_ROUTES.SIGNUP_ORG}
                  className="block w-full rounded-lg bg-primary py-3 text-center font-label-md text-on-primary shadow-lg shadow-primary/20 transition-all hover:opacity-90"
                >
                  Choose Business
                </Link>
              </div>
              ...
              <div className="bg-white border border-border-subtle p-8 rounded-2xl hover:border-primary transition-colors flex flex-col">
                <div className="font-label-md text-outline mb-4">
                  ENTERPRISE
                </div>
                <div className="text-headline-xl font-headline-xl mb-6">
                  Custom
                ...
                <p className="text-on-surface-variant mb-8 font-body-md">
                  Bespoke solutions for national portfolios and large
                  enterprises.
                </p>
                <ul className="space-y-4 mb-12 flex-grow">
                  <li className="flex items-center gap-3 font-body-md">
            ...
            <div className="bg-surface-container-high rounded-4xl p-12 lg:p-20 relative overflow-hidden border border-border-subtle">
              ...
              <div className="relative z-10">
                ...
                <p className="text-on-surface-variant text-body-lg mb-10 max-w-xl mx-auto">
                  Join over 5,000 organizations and technicians who trust
                  MaintainPro for their critical infrastructure needs.
                </p>
